...
setup(
    ...
    package_data={
        "droidbot": [
            os.path.relpath(x, "droidbot") for x in findall("droidbot/resources/")
        ]
    },
    ...
    # install_requires=['androguard==3.4.0a1', 'networkx', 'Pillow'],#HACK: 修复 ModuleNotFoundError: No module named 'androguard.core.bytecodes' 问题
    install_requires=["androguard>=4", "networkx", "Pillow"],  # 支持更多apk
)
